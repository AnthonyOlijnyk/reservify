...
urlpatterns = [
    ...
    path('api/users/<str:username>/update/', UserUpdateUsernameView.as_view(), name='username-update'),
    path('api/users/<str:username>/update_password/', UserUpdatePasswordView.as_view(), name='password-update'),
